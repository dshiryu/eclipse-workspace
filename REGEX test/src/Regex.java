...
public class Regex {
	...
	public static void main(String[] args) {
	    ...
	    for(;;) {
	      ...
	      if (m.matches())
	        System.out.println("Gueltiger Float: " + Float.parseFloat(input));
	      else
	...
	public static void exemple1() {
		System.out.println("Exemple 1: Matching a string\n");
	...
	public static void exemple2() {
		System.out.println("Exemple 2: Capturing groups\n");
	...
	public static void exemple3() {
		System.out.println("Exemple 3: Finding and replacing strings\n");
